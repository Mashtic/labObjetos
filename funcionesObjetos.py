...
# Programa principal
listaMiembros = insertarMiembroES() # Prueba de que sirve
print(reporteCompleto(listaMiembros)) # En menú se deben imprimir
modificarMiembroES(listaMiembros)
print(reporteIndividualES(listaMiembros)) # En menú se deben imprimir
